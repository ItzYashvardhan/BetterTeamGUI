...
//            val msg = _root_ide_package_.me.justlime.betterTeamGUI.data.config.ConfigManager.messages.getString("no-permission") ?: ""
//            sendMessage(sender, msg)
            return
        }
        if (sender !is Player) {
//            val msg = _root_ide_package_.me.justlime.betterTeamGUI.data.config.ConfigManager.messages.getString("player-only.chat") ?: ""
//            sendMessage(sender, msg)
            return
        }
