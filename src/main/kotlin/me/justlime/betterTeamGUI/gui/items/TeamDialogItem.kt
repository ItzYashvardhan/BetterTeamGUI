...
object TeamDialogItem {
    ...
    fun reload() {
        ...
        leaveBackground = config.loadItems(JGui.DialogView.LEAVE_VIEW_BACKGROUND)
        ...
        demoteToAdminConfirmItem = config.loadItem(JGui.DialogView.DEMOTE_TO_ADMIN_CONFIRM_ITEM)
        demoteToAdminCancelItem = config.loadItem(JGui.DialogView.DEMOTE_TO_ADMIN_CANCEL_ITEM)
